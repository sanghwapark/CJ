...
Structure functions are also avaiable (F2 neutral current only for now) as
* CJ15nlo-F2NC

The grids from the earlier **CJ12* NLO analysis are also available, although these have been superceded by the CJ15 PDFs. [See the original reference](http://inspirehep.net/record/1206325?ln=en) for details. Available grids are:
* CJ12min
* CJ12mid
* CJ12max 
